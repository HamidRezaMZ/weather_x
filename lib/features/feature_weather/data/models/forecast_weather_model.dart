...
class AirQuality {
  ...
  dynamic get ukAirQualityIndex {
    if (gbDefraIndex! <= 3) return "Low";
    if (gbDefraIndex! <= 6) return "Moderate";
    if (gbDefraIndex! <= 9) return "High";
    if (gbDefraIndex! == 10) return "Very High";
    return "Unknown";
  }
